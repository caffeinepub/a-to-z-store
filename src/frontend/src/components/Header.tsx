      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {/* WhatsApp */}
            <a
              href="https://wa.me/919278184637"
              target="_blank"
              rel="noopener noreferrer"
              data-ocid="header.whatsapp_link"
              className="flex items-center gap-1.5 text-sm font-semibold text-green-500 hover:text-green-600 transition-colors"
            ...
            >
              ...
              <span className="hidden sm:inline">9278184637</span>
            </a>
